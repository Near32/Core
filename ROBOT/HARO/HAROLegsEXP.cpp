...
void HAROLegsEXP::setDq( const Mat<float>& dq)
{
	for(int i=1;i<=5;i++)
	{
		...
		switch(i)
		{
			...
			case 2:
			{
				x2r.setValue( x2r.getValue()+toRad(dq.get(3,1)) );
				//std::cout << x2r.evaluate() << std::endl;
			}
			break;
			...
			case 3:
			{
				x3r.setValue( x3r.getValue()+toRad(dq.get(5,1)) );
				//std::cout << x3r.evaluate() << std::endl;
			}
			break;
			...
			case 4:
			{
				x4r.setValue( x4r.getValue()+toRad(dq.get(7,1)) );
				//std::cout << x4r.evaluate() << std::endl;
			}
			break;
			...
			case 5:
			{
				x5r.setValue( x5r.getValue()+toRad(dq.get(9,1)) );
				//std::cout << x5r.evaluate() << std::endl;
			}
			break;
		}
	...
	for(int i=1;i<=5;i++)
	{
		...
		switch(i)
		{
			case 1:
			{
				x1l.setValue( x1l.getValue()+toRad(dq.get(2,1)) );
				//std::cout << x1l.evaluate() << std::endl;
			}
			break;
			...
			case 2:
			{
				x2l.setValue( x2l.getValue()+toRad(dq.get(4,1)) );
				//std::cout << x2l.evaluate() << std::endl;
			}
			break;
			...
			case 3:
			{
				x3l.setValue( x3l.getValue()+toRad(dq.get(6,1)) );
				//std::cout << x3l.evaluate() << std::endl;
			}
			break;
			...
			case 4:
			{
				x4l.setValue( x4l.getValue()+toRad(dq.get(8,1)) );
				//std::cout << x4l.evaluate() << std::endl;
			}
			break;
