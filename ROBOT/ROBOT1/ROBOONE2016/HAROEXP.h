...
typedef Mat<EXP<float> > (RobotPart::*Function)(void) const;
...
class ActionParams
{
	...
	std::vector<Mat<EXP<float> > > Traj2J;							//EXP of the Jacobian matrix related to the interesting variables.
...
class HAROEXP
{
	...
	std::map<int,Mat<EXP<float> > > idxTraj2J;
	bool trajREADY;
